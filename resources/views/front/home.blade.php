                                ...
                                <ul class="thumbnails">
                                    @foreach ($product as $value)
                                        <li class="span3">
                                            <div class="thumbnail">
                                                <i class="tag"></i>
                                                <a href="{{ route('productView', $value->id) }}"><img
                                                        src="{{ asset('uploads/' . $value->image) }}" alt=""></a>
                                                <div class="caption">
                                                    <h5>{{ $value->name }}</h5>
                                                    <h4><a class="btn"
                                                            href="{{ route('productView', $value->id) }}">VIEW</a> <span
                                                            class="pull-right">&#8377;{{ $value->price }}</span></h4>
                                                </div>
                                            </div>
                                        </li>
                                    @endforeach
        ...
        <ul class="thumbnails">
            @foreach ($new_products as $new_product)
                <li class="span3">
                    <div class="thumbnail">
                        <a href="{{ route('productView', $value->id) }}"><img
                                src="{{ asset('uploads/' . $new_product->image) }}"
                                style="width:880 !important; height:503!important;" alt="" /></a>
                        <div class="caption">
                            ...
                            <h4 style="text-align:center"><a class="btn" href="{{ route('productView', $value->id) }}">
                                    <i class="icon-zoom-in"></i></a> <a class="btn" href="#">Add to <i
                                        class="icon-shopping-cart"></i></a> <a class="btn btn-primary"
                                    href="#">&#8377;{{ $new_product->price }}</a>
                            </h4>
                        </div>
                    </div>
                </li>
